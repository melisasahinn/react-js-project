            ...
            <div class="bg-gray-100 w-full min-h-screen gap-4 flex-wrap flex justify-center items-center">
                <div class="w-80 p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
                    ...
                    <div className=" flex justify-center">
                        <img class="h-40 w-40 object-cover rounded-3xl"  src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="" />
                    </div>
                    <div class="p-2">
                        <div>
                            <h2 class=" text-center font-bold text-lg mb-2 ">Melisa Melisa</h2>
                        </div>
                    ...
                    <div class="m-2 flex gap-4 justify-between">
                        <div className="text-center text-neutralGrey ">
                            <a>En Yakın Tarih</a>
                            <div className="border"></div>
                            <a>09.11.2023 13:00</a>
                        </div>
                        <a role='button' href='#' class="text-white bg-purple-600 px-3 py-3 mx-auto rounded-md hover:bg-purple-700 ">Randevu Al</a>
                    </div>
                </div>
                <div class="w-80 p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
                    <div className="w-70 p-2 bg-gray-200 rounded-2xl mb-2">
